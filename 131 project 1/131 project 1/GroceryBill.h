...
private:
	...
	// TO BE COMPLETED
	const PriceList * shopList;
	double tax;
	double total;
	PriceListItem * bill;  // list of items in cart
	int billNum;           // amount of unique items in cart
	double * quantities;   // keeps track of quantity of each item
};
